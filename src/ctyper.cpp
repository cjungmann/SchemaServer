...
const _CType CTyper::s_types[] = {
   ...
   { MYSQL_TYPE_TIME, false, CT_TIME_TIME, _CType::TYPE_TIME,
     sizeof(MYSQL_TIME), ai_time::cast_and_use, "TIME", "time",
     "time", "time-value" },
   { MYSQL_TYPE_DATETIME, false, CT_TIME_DATETIME, _CType::TYPE_TIME,
     sizeof(MYSQL_TIME), ai_datetime::cast_and_use, "DATETIME", "datetime",
     "date", "date-value" },
   { MYSQL_TYPE_TIMESTAMP, true, CT_TIME_DATETIME, _CType::TYPE_TIME,
     sizeof(MYSQL_TIME), ai_datetime::cast_and_use, "TIMESTAMP", "timestamp",
     "date", "date-value" },
